...
if (browserMatch && ("chrome" === browserMatch.browser) && version >= "45") {
    var img;
    img = new Image();
            ...
            if (typeof jsonData !== "undefined") {
                if (varNtkoGUID === jsonData["ntkoGUID"]) {
                    if ("ntkoClose" === jsonData["functionName"]) {
                        // eval('ntkoCloseEvent()');
                        window.ntkoCloseEvent && window.ntkoCloseEvent();
                    }
                        ...
                        if (typeof varFunctionName != 'undefined' && ((null != varFunctionName) && ("" != varFunctionName))) {
                            ...
                            if (typeof varFunctionAgrvs != 'undefined' && ((null != varFunctionAgrvs) && ("" != varFunctionAgrvs))) {
                                ...
                                window[varFunctionName] && window[varFunctionName](varFunctionAgrvs[0],varFunctionAgrvs[1],varFunctionAgrvs[2],varFunctionAgrvs[3],varFunctionAgrvs[4],varFunctionAgrvs[5],varFunctionAgrvs[6],varFunctionAgrvs[7],varFunctionAgrvs[8])
                            }
                        }
...
function ieattachEventntko(data,varFunctionAgrvs) {
    if (typeof data !== "undefined") {
        if (typeof varFunctionAgrvs != 'undefined' && ((null != varFunctionAgrvs) && ("" != varFunctionAgrvs))) {
            ...
            //     "varFunctionAgrvs[4],varFunctionAgrvs[5],varFunctionAgrvs[6],varFunctionAgrvs[7],varFunctionAgrvs[8]);");
            window[data] && window[data](varFunctionAgrvs[0],varFunctionAgrvs[1],varFunctionAgrvs[2],varFunctionAgrvs[3],varFunctionAgrvs[4],varFunctionAgrvs[5],varFunctionAgrvs[6],varFunctionAgrvs[7],varFunctionAgrvs[8])
        }
    }
